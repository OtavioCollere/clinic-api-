...
import { FetchAppointmentsUseCaseRequest } from "../use-cases/appointments/fetch-appointments";
...
export abstract class AppointmentsRepository{
  ...
  abstract getAll({query, page } : FetchAppointmentsUseCaseRequest) : Promise<Appointment[]>
